...
<form id="login2" action="serve" method="get" >
						...
						<div id="favourites-list">
							<div class="side-widget-content">
								<div class="user-details-wrapper active"
									...
									<div class="user-details">
										<div class="user-name">Maria Cardenas</div>
										<div class="user-more">Intendente</div>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="user-details-wrapper active"
									...
									<div class="user-details">
										<div class="user-name">Luz Flores</div>
										<div class="user-more">Supervisor</div>
									</div>
									<div class="clearfix"></div>
								</div>
...
/*
		...
		url : '/serve',
		type : 'get',
		data : {'blob-key' : JSON.stringify(blob)},
