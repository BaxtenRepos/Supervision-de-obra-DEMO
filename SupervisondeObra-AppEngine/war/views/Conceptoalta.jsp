...
<script src="/js/Altaconcepto.js"></script>
			...
			<div class="content">
				...
				<center>
					<select id="obraselect" style="width: 100% color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #FFFFFF;"
							onchange="envia()" name="obraselect" >
							<option value="volvo">Seleccione la Obra</option>
						</select>
			  <div class="fileUpload btn btn-primary" >	
					<form name="frm" action="/excel" method="post"  enctype="multipart/form-data" >
		     <input  class="fileUpload btn btn-primary" type="file" name="fl_upload">
