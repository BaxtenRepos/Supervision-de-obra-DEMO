...
<link rel="stylesheet" href="assets/css/dialog.css" type="text/css">
 ...
 <script src="/js/Logotiposalta.js"></script>
      ...
      <div class="pull-right"> 
		<div class="chat-toggler">	
				...
				<div class="profile-pic"> 
					<img src="assets/img/profiles/avatar_small.png"  alt="" data-src="assets/img/profiles/avatar_small.png" data-src-retina="assets/img/profiles/avatar_small2x.jpg" width="35" height="35" /> 
				</div>       			
			</div>
		 <ul class="nav quick-section ">
  ...
  <!-- BEGIN MINI-PROFILE -->
   ...
   <div class="user-info-wrapper">
	...
	<div class="profile-wrapper">
		<img src="assets/img/profiles/avatar1.jpg "  alt="" data-src="assets/img/profiles/avatar1.jpg " data-src-retina="assets/img/profiles/avatar2x.jpg" width="69" height="69" />
	</div>
    <div class="user-info">
     
      <div class="username">Juan Carlos <br> Gonzalez <br> Solorzano  </div>
    ...
    <div class="content">  
	    <div class="grid-body no-border"> <br>
                 <div class="page-title">
					<h3><b> Alta de Logotipos</b></h3>
		    </div>
			<br>
			
      <form action="<%= blobstoreService.createUploadUrl("/altalogotipo") %>" method="post" enctype="multipart/form-data" >	  
		<!-- selección de Proyectos -->  
			  <div class="form-group">
                 <label class="form-label">Proyecto</label>
                <div class="controls">
                 		<select id="altaLogotipo_proyectoselect" name="altaLogotipo_proyectoselect" style="width:100%" onchange="changeProyectoEdit();">
   
                 		</select>
		           </div>
           </div>       
      	<div class="form-group">
								<label class="form-label">Logo Secretaria</label>
								<input class="btn btn-primary btn-cons " type="file" name="myFile_secretaria" accept="image/x-png, image/jpeg" id="myFile_secretaria">
                        <div class="controls">
                        	<img id="img_secretaria" src="#" alt="your image" />
                        </div>
                      </div>
		     <div class="form-group">
                        <label class="form-label">Logo Dependencia</label>
                        <input class="btn btn-primary btn-cons " type="file" name="myFile_dependencia" accept="image/png, image/jpeg" id="myFile_dependencia">
                        <div class="controls">
                        	<img id="img_dependencia" src="#" alt="your image" />
                        </div>
                      </div>
                      
           <div class="form-group">
                        <label class="form-label">Logo IUYET</label>
                        <input class="btn btn-primary btn-cons " type="file" name="myFile_iuyet" accept="image/x-png, image/jpeg" id="myFile_iuyet">
                        <div class="controls">
                        	<img id="img_iuyet" src="#" alt="your image" />
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Logo Adicional</label>
                        <input class="btn btn-primary btn-cons " type="file" name="myFile_adicional" accept="image/x-png, image/jpeg" id="myFile_adicional">
                        <div class="controls">
                        	<img id="img_adicional" src="#" alt="your image" />
                        </div>
                      </div>
			<div class="form-group" >
                        <div class="controls">
