...
<link rel="stylesheet" href="assets/css/dialog.css" type="text/css">
 ...
 <script src="/js/Personaalta.js"></script>
 ...
 <!--   <select id="e1">
        ...
        <option value="WY">Azul</option>
        <option value="WY">Amarillo</option>
        <option value="WY">Morado</option>
    </select>-->
...
<body class="" onload = "valida();"> <!-- onload = "init()" -->
 <script type="text/javascript">
      (function() {
       var po = document.createElement('script'); po.type = 'text/javascript'; po.async = true;
       po.src = 'https://apis.google.com/js/client:plusone.js';
       var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
       $("#AltaPersona_empresa").select2({placeholder: "Select a State"});
       $("#e1").select2({placeholder: "Select a State"});
     })();
    </script>
...
<div class="page-container row-fluid">
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
		...
		<!--  <div class="form-group">
                     ...
                     <a href="./AltaCatTipoPersona.jsp">
                           <button class="btn btn-primary btn-cons " alingh>Dar de alta Tipo de Persona</button>
                        	</a>
                     <div class="controls">
		    				<select id="catTipoPersona" style="width:100%"  >
                 			</select>
        ...
        <form action="<%= blobstoreService.createUploadUrl("/altapersonal") %>" method="post" enctype="multipart/form-data" id="formulario1" acceptcharset="UTF-8" >
		   <div class="form-group">
                        <label class="form-label">Nombre</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_Nombre" name="AltaPersona_Nombre" maxlength="20">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Apellido Paterno</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_ApPaterno" name="AltaPersona_ApPaterno" maxlength="20">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Apellido Materno</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_ApMaterno" name="AltaPersona_ApMaterno" maxlength="20">
                        </div>
                      </div>
             <div class="form-group">
                        <label class="form-label">Iniciales</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_Iniciales" name="AltaPersona_Iniciales" maxlength="10">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Fecha de Nacimiento</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_FechaNaci" name="AltaPersona_FechaNaci">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Direcci&oacute;n</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_Direccion" name="AltaPersona_Direccion" maxlength="200">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Tel&eacute;fono</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_Telefono" name="AltaPersona_Telefono" maxlength="20">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Radio</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_Radio" name="AltaPersona_Radio" maxlength="100">
                        </div>
                      </div>
			<div class="form-group">
   ...
   <!--       <form class="form-no-horizontal-spacing" id="form-condensed">--> 
         <div class="row form-row">
                      <div class="col-md-12">
                        <input name="form3Email" id="form3Email" type="text"  class="form-control" name="form3Email" maxlength="254">
                      </div>
                    </div>             
    <!--       </form>-->
         ...
         <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_rfc" name="AltaPersona_rfc" onchange="validarRFC()" maxlength="13">
                        </div>
			...
			<div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_Cargo" name="AltaPersona_Cargo" maxlength="20">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">T&iacute;tulo Profesional</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_TituloProfesional" name="AltaPersona_TituloProfesional" maxlength="50">
                        </div>
                      </div>
                      
			<div class="form-group">
                        <label class="form-label">C&eacute;dula Profesional</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_CedulaProfesional" name="AltaPersona_CedulaProfesional" maxlength="20">
                        </div>
                      </div>
         ...
         <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" class="form-control" id="AltaPersona_UsuarioSkype" name="AltaPersona_UsuarioSkype" maxlength="30">
                        </div>
                      </div>
  ...
  <!--         				<div class="controls">-->
		    				<select id="AltaPersona_empresa" name="AltaPersona_empresa" style="width:100%"> </select>
                    <!--    </div>-->
         </div>
         
  			   <div class="fileUpload btn btn-primary" >
         				<label class="form-label">Foto de perfil</label>
                       	<input  type="file"  class="upload" name="myFile" accept="image/png, image/jpeg" id="myFile">
...
<!--  			<div class="form-group">
                        <div class="controls">
                          <button class="btn btn-block btn-success "  id="AltaPersonaEnviar"  OnClick="AltaPersonaenviar();">Guardar</button><br><br><br><br><br><br>
                        </div>
                      </div>-->
