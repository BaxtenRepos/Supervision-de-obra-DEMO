...
function endpoints(){
    ...
    idDirectivo = 1;
    //valor = getGET().No_proyectos;
          //Consultar EndPoint Proyectos
          gapi.client.load('communicationchannel', 'v1', function(){
                      gapi.client.communicationchannel.listDirectivo_Proyecto({"directivo": idDirectivo}).execute(function(resp){
                                 if(resp.code) {
           ...
           gapi.client.communicationchannel.listObra({"idProyecto": "0", "idObra":"0"}).execute(function(resp){
           if(resp.code) {
...
function insertarDirectorioProyectos(x) {
           ...
           } else if (DirectorioItems && x >= DirectorioItems.length > 0) {
                      //code     
                      console.log("Cargando Directorio: " + DirectorioItems.length);
                      idDirectorio
                      TipoEmpresa
                      Nombre
                      ApPaterno
