...
<link rel="stylesheet" href="assets/css/dialog.css" type="text/css"/>
 ...
 <script src="/js/Catmaquinariaalta.js"></script>
</head>
<!-- END HEAD -->
   ...
   <!-- BEGIN SIDEBAR MENU -->	
    ...
    <li class=""><a href="#"><i class="fa fa-folder-open"></i><span class="title">Biblioteca</span><span
	  ...
	  <li class=""> <a href="index.html"> <i class="fa fa-power-off"></i> <span class="title">Cerrar Sesion</span></a>
	    <ul class="sub-menu">
		   <li > <a href="index.html"> <i class="fa fa-power-off"></i> Cerrar Sesion </a> </li>
               </ul>
	  </li>
    </ul>
		...
		<div class="grid-body no-border"> <br>
			...
			<br>
		        ...
		        <div class="form-group">
                        <label class="form-label">Tipo Maquinaria</label>
                        <span class="help">e.j. "Maquinaria Pesada - Maquinaria Ligera"</span>
                        <div class="controls">
                          <input type="text" class="form-control" id="CatMaquinaria_tipoMaquinaria">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Descripción</label>
                        <div class="controls">
                          <input type="text" class="form-control" id="CatMaquinaria_Descripcion">
                        </div>
                      </div>
			
			<div class="form-group">
                        <div class="controls">
                          <button class="btn btn-block btn-success "  id="CatMaquinariaEnviar"  OnClick="enviarCatTipoMaquinaria();">Guardar</button><br>
                        </div>
                      </div>
		   <div class="form-group">
