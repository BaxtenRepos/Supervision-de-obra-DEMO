...
<script src="/js/multimediaProyecto.js"></script>
</head>
<!-- END HEAD -->
...
<body class="" onload="valida();">
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			...
			<div class="content">
				...
				<!-- selección de obra  aquiiiiiiiiiiiiiii-->
				
				<center>
				<select id="obraselect" style="width: 100% color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #FFFFFF;"
							onchange="cambio()" name="obraselect" >
							<option value="volvo">Seleccione un proyecto</option>
						</select>
					<!-- /multimedia-->
			  <div class="fileUpload btn btn-primary" >	
					<form  action="<%= blobstoreService.createUploadUrl("/multimedia") %>" method="post"  enctype="multipart/form-data" >
		     <input   value="Submgbvgfgrfedwsdvit" type="file" name="archivo">
		      <div class="form-group">
                          <input type="hidden" class="form-control" id="tiporeferencia" name="tiporeferencia">
                            <input type="hidden" class="form-control" id="idreferencia" name="idreferencia">
                    </div>	
			 <input type="submit" value="Subir archivos" STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #000000;">
			 <input type="reset" value="cancel" STYLE="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #000000;">
			 <div class="controls">
	...
	-->
					...
					<img src="assets/img/semarnat.png" width="15%" height="100%"
						style="margin-left:10%;"></img> 
						<img
						src="assets/img/segob.jpeg" width="15%" height="85%"
						style="margin-left:10%;"></img> 
