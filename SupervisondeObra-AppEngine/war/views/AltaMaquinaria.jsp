...
<link rel="stylesheet" href="assets/css/dialog.css" type="text/css">
 ...
 <script src="/js/Maquinariaalta.js"></script>
    ...
    <div class="content">  
		<div class="grid-body no-border"> <br>
		   ...
		   <!-- 
		       <div class="form-group">
						<label class="form-label">Tipo de Maquinaria</label>
                      		<a href="./AltaCatTipoMaquinaria.jsp">
                          	 <button class="btn btn-primary btn-cons " >Dar de alta Tipo de Maquinaria</button>
                        	</a>
                      </div>
               ...
               <form action="<%= blobstoreService.createUploadUrl("/uploadMaquinaria") %>" method="post" enctype="multipart/form-data" id="formulario1" acceptcharset="UTF-8">        
			<div class="form-group">   
					   <label class="form-label">Tipo de Maquinaria</label>             
                    	<div class="controls">
		    						<select id="TipoMaquinaria" name="TipoMaquinaria1" style="width:100%" >
               ...
               <div class="fileUpload btn btn-primary" >
         				<label class="form-label">Foto de Maquinaria</label>
		   ...
		   <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" class="form-control" name="AltaMaquinaria_Nombre" id="AltaMaquinaria_Nombre" maxlength="200"">
                        </div>
                      </div>
			<div class="form-group">
                        <label class="form-label">Descripci&oacute;n</label>
                        <div class="controls">
                          <input type="text" class="form-control" name="AltaMaquinaria_Descripcion" id="AltaMaquinaria_Descripcion" maxlength="500">
                        </div>
                      </div>
