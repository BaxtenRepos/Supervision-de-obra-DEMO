...
<script src="/js/generaReporte.js"></script>
...
<link rel="stylesheet" type="text/css"
	href="media/css/dataTables.responsive.css">
...
<script type="text/javascript" language="javascript"
	src="media/js/dataTables.responsive.js"></script>
</head>
<!-- END HEAD -->
			...
			<!--  				Juan Carlos <br> Gonzalez <br> Solorzano-->
				...
				<li class=""><a href="#"><i class="fa fa-folder-open"></i><span class="title">Biblioteca</span><span
						...
						<ul class="sub-menu">
							...
							<!-- <li><a href="#"> Editar ./multimedia.jsp </a></li> -->
						</ul></li>
					<li class=""><a href="#"><i
			...
			<div class="content">
				<div class="grid-body no-border">
					<div class="page-title">
						...
						<select  style="width: 100% color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #FFFFFF;"
							onchange="cambioProyecto()" name="proyectoselect" id ="proyectoselect">
							<option value="volvo">Seleccione un Proyecto</option>
						</select>
						
						<select hidden = "true" id="obraselect" style="width: 100% color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #FFFFFF;"
							onchange="cambioObra()" name="obraselect" >
							<option value="volvo">Seleccione una Obra</option>
						</select>
						<div id = "checkconvenio" hidden = "true">
						<input id = "check" type="checkbox" name="conveniocheck" value="Cheese"> Existe Convenio?<br>
						</div>
						<div id="cambios" hidden="true">
						

							<div class="form-group">
								<label class="form-label">*N&uacute;mero de Convenio </label>
								<div class="controls">
									<input type="text" class="form-control" id="NumeroConvenio" maxlength="200">
								</div>
							</div>
							<div class="form-group">
								<label class="form-label">*Fecha de Convenio</label>
								<div class="controls">
									<input type="text" class="form-control" id="Fechaconvenio" maxlength="200">
								</div>
							</div>
							<div class="form-group">
								<label class="form-label">*Importe de Convenio </label>
								<div class="controls">
									<input type="text" class="form-control" id="ImporteConvenio" maxlength="200">
								</div>
							</div>
							<div class="form-group">
								<label class="form-label"> *Plazo de ejecuci&oacute;n (días naturales):</label>
								<div class="controls">
									<input type="text" class="form-control" id="Dias" maxlength="200">
								</div>
							</div>
							<div class="form-group">
								<label class="form-label">*Fecha de inicio:	 </label>
								<div class="controls">
									<input  type="text" class="form-control" id="Fechainicio" maxlength="200">
								</div>
							</div>
							<div class="form-group">
								<label class="form-label">*Fecha de t&eacute;rmino:	 </label>
								<div class="controls">
									<input type="text" class="form-control" id="Fechafin" maxlength="200">
								</div>
							</div>
						...
						<div class="controls" id="boton" hidden = "true">
									<button class="btn btn-block btn-success " id="enviar"
