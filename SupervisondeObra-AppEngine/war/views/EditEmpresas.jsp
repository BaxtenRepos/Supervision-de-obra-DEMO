...
<link href="assets/plugins/jquery-slider/css/jquery.sidr.light.css"
	rel="stylesheet" type="text/css" media="screen" />
<!-- BEGIN CORE CSS FRAMEWORK -->
<link href="assets/plugins/boostrapv3/css/bootstrap.min.css"
	rel="stylesheet" type="text/css" />
<link href="assets/plugins/boostrapv3/css/bootstrap-theme.min.css"
	rel="stylesheet" type="text/css" />
...
<script src="/js/Empresaedit.js"></script>
...
<body class="" onload="valida();">
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			...
			<div class="content">
				...
				<form action="<%= blobstoreService.createUploadUrl("/editempresa") %>" method="post" enctype="multipart/form-data" id="formularioE" >
				
					<div class="form-group">
						<label class="form-label">RFC</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_rfc" name="editEmpresa_rfc" onchange="validarRFC()" maxlength="13">
						</div>
					...
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_nombre" name="editEmpresa_nombre" maxlength="500">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Siglas</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_siglas" name="editEmpresa_siglas" maxlength="20">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">IMSS</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_imss" name="editEmpresa_imss" maxlength="20">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Calle</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_calle" name="editEmpresa_calle" maxlength="180">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Num. Exterior</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_num_ext" name="editEmpresa_num_ext" maxlength="5">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Num. Interior</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_num_int" name="editEmpresa_num_int" maxlength="5">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Colonia</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_colonia" name="editEmpresa_colonia" maxlength="100">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Delegaci&oacute;n o municipio</label>
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_del_mun" name="editEmpresa_del_mun" maxlength="100">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Entidad</label>
						<div class="controls">
							<select id="editEmpresa_entidad" name="editEmpresa_entidad" style="width: 100%">
					...
					<div class="form-group">
						...
						<div class="controls">
							<input type="text" class="form-control" id="editEmpresa_codigo_postal" name="editEmpresa_codigo_postal" maxlength="5">
						</div>
					</div>
					<div class="form-group">
						<label class="form-label">Tipo de empresa</label>
						<div class="controls">
							<select id="editEmpresa_selectempresa" style="width: 100%" name="editEmpresa_selectempresa"> </select>
						</div>
					</div>
					
					<div class="fileUpload btn btn-primary">
						<label class="form-label">Seleccionar Logo</label> 
						<input  class="upload" type="file" name="myFile_editempresa" accept="image/png, image/jpeg" id="myFile_editempresa"> 
						<img id="blah" name="blah" src="#" alt="your image" style="max-width: 160px; max-height: 120px; border: none;" />
					...
					<div class="form-group">
                          <input type="hidden" class="form-control" id="editEmpresa_Id" name="editEmpresa_Id">
                    </div>
                    <div class="form-group">
			...
			<div class="footer-page">
				...
				<img src="assets/img/logo_semarnat.png" width="20%" height="85%"
					style="margin: 10px; margin-right: 50px"></img> <img
					src="assets/img/logo_segob.png" width="20%" height="85%"
					style="margin: 10px; margin-right: 50px"></img> <img
					src="assets/img/logo_conagua.jpg" width="20%" height="85%"
	...
	<script src="assets/plugins/jquery-unveil/jquery.unveil.min.js"
		type="text/javascript"></script>
	<script src="assets/plugins/jquery-block-ui/jqueryblockui.js"
		type="text/javascript"></script>
	<script
	...
	<!-- BEGIN PAGE LEVEL JS -->
	<script src="assets/plugins/jquery-slider/jquery.sidr.min.js"
		type="text/javascript"></script>
