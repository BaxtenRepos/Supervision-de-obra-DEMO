...
<script src="/js/Maquinariaedit.js"></script>
		...
		<div class="page-sidebar" id="main-menu">
			...
			<!--  				Juan Carlos <br> Gonzalez <br> Solorzano-->
				...
				<li class=""><a href="#"><i class="fa fa-folder-open"></i><span class="title">Biblioteca</span><span
					...
					<li class=""><a href="#"><i class="fa fa-folder-open"></i><span
							class="title">Proyectos</span><span class="arrow"></span></a>
						<ul class="sub-menu">
					...
					<li class=""><a href="#"> <i class="fa fa-edit"></i> <span
						...
						<ul class="sub-menu">
							...
							<li><a href="./ListaCatPeronas.html">Lista Categoria de
									Personal</a></li>
							<li><a href="./AltaCatTipoPersona.jsp">Alta Categoria de
									Personal</a></li>
						</ul></li>
			...
			<div class="content">
				<div class="grid-body no-border">
					...
					<div class="page-title">
					  ...
					  <form action="<%= blobstoreService.createUploadUrl("/editmaquinaria") %>" method="post" enctype="multipart/form-data" id="formulario1" acceptcharset="UTF-8" >
						<div class="form-group">
							<label class="form-label">Tipo de Maquinaria</label>
							<div class="controls">
								<select id="TipoMaquinaria" name="TipoMaquinaria1"
									style="width: 100%">
						...
						<div class="form-group">
							...
							<div class="controls">
								<input type="text" class="form-control" id="EditMaquinaria_Nombre"
									name="EditMaquinaria_Nombre">
							</div>
						</div>
						<div class="form-group">
							<label class="form-label">Descripción</label>
							<div class="controls">
								<input type="text" class="form-control" id="EditMaquinaria_Descripcion"
									name="EditMaquinaria_Descripcion">
							</div>
						</div>
						...
						<div class="form-group">
                          <input type="hidden" class="form-control" id="EditMaquinaria_Id" name="EditMaquinaria_Id">
                    	</div>	
						 <div class="form-group">
