...
//import com.csgit.cao.model.communicationchannel.model.CollectionResponseMessageData;
//import com.csgit.cao.model.communicationchannel.model.MessageData;
...
//				}
//			});
//    channel = CloudEndpointUtils.updateBuilder(builder).build();
//    
//  }
//
//  @Override
...
//         */
////        new QueryMessagesTask(this, messageEndpoint).execute();
//        new QueryMessagesTask(this, channel).execute();
//      }
//    }
//  }
//  
...
//    Exception exceptionThrown = null;
////    MessageEndpoint messageEndpoint;
//    Communicationchannel messageEndpoint;
//
////    public QueryMessagesTask(Activity activity, MessageEndpoint messageEndpoint) {
////      this.messageEndpoint = messageEndpoint;
////    }
//    public QueryMessagesTask(Activity activity, Communicationchannel messageEndpoint) {
//        this.messageEndpoint = messageEndpoint;
//      }
//    
//    @Override
...
//      try {
//        CollectionResponseMessageData messages = 
//            channel.listMessages().setLimit(5).execute();
//        return messages;
//      } catch (IOException e) {
//        exceptionThrown = e;
//        return null;
...
//            "Exception when listing Messages", exceptionThrown);
//        showDialog("Failed to retrieve the last 5 messages from " +
//        		"the endpoint at " + channel.getBaseUrl() +
//        		", check log for details");
//      }
//      else {
//        TextView messageView = (TextView) findViewById(R.id.msgView);
