...
console.log("id de Obra" + idObra);
	db.transaction(function(tx) {
		...
		indice = rs.rows.length;
		      ...
		      puntos[i]={d:fecha, a:p.PorcentajeAvance};
     ...
     db.transaction(function(tx) {
	  tx.executeSql('SELECT * FROM  AvanceFisicoObras ' +
	       ...
	       for(var i = 0; i < 20; i++){
		    ...
		    puntos3[i]={d:fechaadd, a:tendencia};
		    //console.log("puntos d: " + puntos3[i].d);
		    //console.log("puntos a: " + puntos3[i].a);
		    iteracion++;
		    day =day + 15;
	       }
          }, errorCB);
