...
function endpoints(){
                                                       ...
                                                       gapi.client.communicationchannel.listAvance_Fisico({"Tipo_Entidad": "0", "id_referencia": parseInt(ProyectoItems.id_Proyecto) }).execute(function(resp){
                                                                  if(resp.code) {
                                                                            alert("Error de conexi—n, no se ha podido descargar Avances Fisicos, volviendo a intentar. :::" + resp.message );
                                                                             ...
                                                                             if(AvanceFisicoItems.length)console.log("AvanceFisicoProyectosItems: " + AvanceFisicoProyectosItems.length);
           ...
           //------------Avance Financiero de Proyectos -----------------
                                                       ...
                                                       gapi.client.communicationchannel.listAvance_Financiero({"Tipo_Entidad": "0", "id_referencia": parseInt(ProyectoItems.id_Proyecto) }).execute(function(resp){
                                                                  if(resp.code) {
                                                                             alert("Error de conexi—n, no se ha podido descargar Avances Financieros, volviendo a intentar. :::" + resp.message );
                                                                  }else{
                                                                             AvanceFinancieroProyectosItems[i] = resp.items;
           ...
           //------------Multimedia de Proyectos -----------------
                                                       gapi.client.communicationchannel.listMultimedia({"tipoReferencia":"0", "idReferencia": parseInt(ProyectoItems.id_Proyecto),"tipoArchivo":"0"}).execute(function(resp){
                                                                  if(resp.code) {
           ...
           //------------Ubicaciones de Proyecto -----------------
                                                       UbicacionItems = new Array();
                                                       gapi.client.communicationchannel.getUbicaciones({"id":ProyectoItems.id_ubicacion}).execute(function(resp){
                                                                  if(resp.code) {
                                                                             alert("Error de conexi—n, no se ha podido descargar Ubicaciones, volviendo a intentar. :::" + resp.message );
                                                                  }else{
                                                                             UbicacionItems = resp.items;
                                                                             if(UbicacionItems.count)console.log("UbicacionProyectosItems: " + UbicacionItems.length);
           ...
           //------------Directorio de Proyectos -----------------
                                                       ...
                                                       gapi.client.communicationchannel.listDirectorio({"tipoReferencia":"0", "idReferencia":parseInt(ProyectoItems.id_Proyecto)}).execute(function(resp){
                                                                  if(resp.code) {
                                                                             alert("Error de conexi—n, no se ha podido descargar Ubicaciones, volviendo a intentar. :::" + resp.message );
                                                                  }else{
                                                                             DirectorioProyectosItems = resp.items;
              ...
              // alert("Obras:" + ObrasItems[i].id_Obra);
                                                                             gapi.client.communicationchannel.listAvance_Fisico({"Tipo_Entidad": "1", "id_referencia": parseInt(ObrasItems[j].id_Obra) }).execute(function(resp){
                                                                                        if(resp.code) {
                                                                                                   ...
                                                                                                   AvanceFisicoItems = resp.items;
                                                                                                   if(AvanceFisicoItems.length)console.log("Avance fisico obras: " + AvanceFisicoObrasItems.length);
                                                                                                   document.getElementById("endpoint4").innerHTML= "Avances Fisicos: <img src=\" biblioteca/Imagenes/check.png\" width=\"20px\" heigth=\"20px\">";
                                                                                        }
                                                                             });//list
           ...
           //------------Ubicacion de Obras -----------------
                                                                             ...
                                                                             gapi.client.communicationchannel.getUbicaciones({"id":parseInt(ObrasItems[j].id_ubicacion)}).execute(function(resp){
                                                                                        if(resp.code) {
                                                                                                   ...
                                                                                                   UbicacionItems = resp.items;
                                                                                                   if(UbicacionItems.length)console.log("UbicacionObrasItems: " + UbicacionItems.count);
                                                                                                   document.getElementById("endpoint6").innerHTML = "Ubicaciones: <img src=\" biblioteca/Imagenes/check.png\" width=\"20px\" heigth=\"20px\">";
                                                                                        }
                                                                             });//list              
           //------------Directorio de Obras -----------------
...
function insertarInformacion(x) {
           ...
           //if (ProyectoItems && x >= ProyectoItems.size) {
           ...
           //console.log("Validando Proyecto = " + validaProyecto(ProyectoItems[x].id_Proyecto) +" idProyecto= "+ProyectoItems[x].id_Proyecto+" idDirectivo= "+ getGET().idDirectivo);
                     ...
                     //code
            idProyecto=ProyectoItems.id_Proyecto;
            NombreLargo=ProyectoItems.nombre_largo;
            NombreCorto=ProyectoItems.nombre_corto;
            Descripcion=ProyectoItems.id_Descripcion;
            Dependencia=ProyectoItems.id_dependencia;
            Secretaria=ProyectoItems.id_secretaria;
            LimiteDesvio="15%";
            Desvio="0%";
                                                            // LimiteDesvio=items[0].nombre_corto;
                                                            // Desvio=items[0].nombre_corto;
            idUbicacion=ProyectoItems.id_ubicacion;
