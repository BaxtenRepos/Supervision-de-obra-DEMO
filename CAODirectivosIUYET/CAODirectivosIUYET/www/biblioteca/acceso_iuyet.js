...
if (window.location.hostname == 'localhost'
   ...
   //var ROOT = 'http://' + 'focal-furnace-615.appspot.com' + '/_ah/api';
}
/*function rstr_md5(s)
{
...
function login(){
   ...
   //passencriptada = CryptoJS.SHA256(password_2);
   //passencriptada = CryptoJS.SHA1(password);
   //passencriptada = "39a1bf481dd91e0c510c5bc27f9398e0";
